...
with open(r'c:\Users\Baha\Desktop\NEX-APP\lib\screens\settings_screen.dart', 'r', encoding='utf-8') as f:
    content = f.read()
...
'''
content = content.replace("bool _gyroMovementEnabled = false;", state_vars + "\n  bool _gyroMovementEnabled = false;")
...
init_calls = '''
    ...
    _loadDevOptions();
'''
content = content.replace("super.initState();", "super.initState();" + init_calls)
...
'''
content = content.replace("// Logout Button", sections_to_add + "\n              // Logout Button")


new_about = '''              _buildSettingsTile(
                icon: Icons.info,
                title: 'About',
...
with open(r'c:\Users\Baha\Desktop\NEX-APP\lib\screens\settings_screen.dart', 'w', encoding='utf-8') as f:
    f.write(content)
print('Done!')
