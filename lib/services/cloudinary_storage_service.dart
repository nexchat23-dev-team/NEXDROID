...
class CloudinaryStorageService {
  ...
  static const List<CloudinaryVault> vaultPool = [
    ...
    CloudinaryVault(
      id: 16,
      name: 'Cloudinary Vault 16 (NEXVAULT16 - Reserve)',
      cloudName: 'nexvault16',
    ...
    CloudinaryVault(
      id: 17,
      name: 'Cloudinary Vault 17 (NEXVAULT17 - Reserve)',
      cloudName: 'nexvault17',
    ...
    CloudinaryVault(
      id: 18,
      name: 'Cloudinary Vault 18 (NEXVAULT18 - Reserve)',
      cloudName: 'nexvault18',
    ...
    CloudinaryVault(
      id: 19,
      name: 'Cloudinary Vault 19 (NEXVAULT19 - Reserve)',
      cloudName: 'nexvault19',
    ...
    CloudinaryVault(
      id: 20,
      name: 'Cloudinary Vault 20 (NEXVAULT20 - Reserve)',
      cloudName: 'nexvault20',
    ...
    CloudinaryVault(
      id: 21,
      name: 'Cloudinary Vault 21 (NEXVAULT21 - Reserve)',
      cloudName: 'nexvault21',
    ...
    CloudinaryVault(
      id: 22,
      name: 'Cloudinary Vault 22 (NEXVAULT22 - Reserve)',
      cloudName: 'nexvault22',
